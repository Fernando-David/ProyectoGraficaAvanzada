...
std::shared_ptr<ThirdPersonCamera> camera(new ThirdPersonCamera());//Administrador de apuntadores.
...
void scrollCallback(GLFWwindow *window, double xScrollOffset, double yScrollOffset);// Implementacion de la funcion para el scroll del mouse
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	glfwSetScrollCallback(window, scrollCallback);// Se asigna la funcion de scroll del mouse a la ventana.
...
void scrollCallback(GLFWwindow *window, double xScrollOffset, double yScrollOffset) {
...
/*	Esto para la camara en primera persona.
...
//	Esto para la camara en tercera persona.
	offsetX = 0;
	offsetY = 0;
