...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelCyborg.loadModel("../models/cyborg/CyborgHuesos.fbx");
...
void applicationLoop() {
	...
	modelMatrixMay = glm::translate(modelMatrixMay, glm::vec3(10,0.0,-5.0));

	modelMatrixGuardian = glm::translate(modelMatrixGuardian, glm::vec3(5, 0.0, -5.0));
	...
	while (psi) {
		...
		*******************************************/
		...
		modelMatrixCowboyBody = glm::scale(modelMatrixCowboyBody, glm::vec3(0.002f));
		modelCowboy.render(modelMatrixCowboyBody);

		glm::mat4 modelMatrixMayBody = glm::mat4(modelMatrixMay);
		modelMatrixMayBody = glm::scale(modelMatrixMayBody, glm::vec3(0.05));
		modelMay.setAnimationIndex(animationMayIndex);
		...
		modelMatrixCyborgBody = glm::scale(modelMatrixCyborgBody, glm::vec3(0.01f));
